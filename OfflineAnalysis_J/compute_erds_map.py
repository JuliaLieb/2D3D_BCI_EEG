...
if __name__ == "__main__":
    ...
    #config_file = '/SubjectData/S91-ses1/CONFIG_S91_run1_ME_3D.json'
    ...
    for f in my_files:
        ...
        if subject_id == 'S92' and motor_mode == 'ME' and 'run2' in f: #vmtl Besonderheit bei einer von Dianas Messungen
        ...
        plot_erds(np.mean(data_1, axis=0), 'ERDS - left hand', sample_rate, motor_mode, mode, 'l')
        plot_erds(np.mean(data_2, axis=0), 'ERDS - right hand', sample_rate, motor_mode, mode, 'r')

    print('ERDS plots done.')
